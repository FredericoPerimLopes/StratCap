...
const validationSchema = Yup.object({
  ...
  allocationMethod: Yup.string()
    .when('paymentType', {
      is: (type: string) => type === 'principal' || type === 'both',
      then: Yup.string().required('Allocation method is required for principal payments'),
    }),
              ...
              <Card>
                <CardContent>
                  ...
                  <Grid container spacing={3}>
                    ...
                    <Grid item xs={12} md={showAllocationMethod ? 6 : 12}>
                      <TextField
                        fullWidth
