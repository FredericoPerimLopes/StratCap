...
from src.routes import health, auth, funds, fund_structures, fund_events, investors, calculations, reports, workflows
...
app.include_router(fund_structures.router, tags=["fund-structures"])
app.include_router(fund_events.router, tags=["fund-events"])
